...
{
    public override Guid CategoryId { get; } = new(TaskCategories.Operation);
    ...
    public override Guid Type { get; } = new("B94C35AA-D324-4381-A05E-B3A5F24FF487"); // TODO: Replace with a new GUID

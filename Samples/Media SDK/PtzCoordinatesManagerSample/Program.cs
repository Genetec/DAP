...
async Task RunSample()
{
    ...
    await GoToPresets(manager, camera);
    await RunPatterns(manager, camera);
    await RunPresetTours(manager, camera);
    await DemonstratePtzControls(manager, camera);
}
...
async Task GoToPresets(PtzCoordinatesManager manager, Camera camera)
{
...
async Task RunPatterns(PtzCoordinatesManager manager, Camera camera)
{
    ...
    foreach (int pattern in patterns)
    {
        ...
        await Task.Delay(2000); // Wait for 2 seconds before stopping the pattern
    }
...
async Task RunPresetTours(PtzCoordinatesManager manager, Camera camera)
{
    ...
    foreach (int tour in presetTours)
    {
        ...
        await Task.Delay(2000); // Wait for 2 seconds before stopping the preset tour
    }
...
async Task DemonstratePtzControls(PtzCoordinatesManager manager, Camera camera)
{
    if (camera.PtzCapabilities.IsSupportedCommand(PtzCommandType.StartPanTilt))
    {
        ...
        await Task.Delay(2000); // Wait for 2 seconds before stopping pan/tilt
    ...
    if (camera.PtzCapabilities.IsSupportedCommand(PtzCommandType.StartZoom))
    {
        ...
        await Task.Delay(2000); // Wait for 2 seconds before stopping zoom
    ...
    if (camera.PtzCapabilities.IsSupportedCommand(PtzCommandType.StartIris))
    {
        ...
        await Task.Delay(2000); // Wait for 2 seconds before stopping iris
    ...
    if (camera.PtzCapabilities.IsSupportedCommand(PtzCommandType.StartFocus))
    {
        ...
        await Task.Delay(2000); // Wait for 2 seconds before stopping focus

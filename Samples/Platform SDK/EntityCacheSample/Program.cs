...
void PrintEntityCache(Engine engine)
{
    ...
    foreach (EntityType entityType in Enum.GetValues(typeof(EntityType)).OfType<EntityType>().Except([EntityType.None, EntityType.ReportTemplate]).OrderBy(type => type.ToString()))
    {

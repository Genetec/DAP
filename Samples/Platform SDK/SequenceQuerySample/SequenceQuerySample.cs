...
{
    public class SequenceQuerySample : SampleBase
    {
        ...
        private void DisplayToConsole(Engine engine, VideoSequence info)
        {
        ...
        private string GetMediaTypeName(Guid mediaTypeGuid)
        {
        ...
        private static string GetStreamUsageName(Guid streamUsage)
        {

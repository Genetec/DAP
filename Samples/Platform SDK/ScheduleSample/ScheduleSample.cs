...
public class ScheduleSample : SampleBase
{
    ...
    private static void CreateEmployeeAccessSchedule(Engine engine)
    {
    ...
    private static void CreateContractorAccessSchedule(Engine engine)
    {
    ...
    private static void CreateSystemMaintenanceSchedule(Engine engine)
    {
    ...
    private static void CreateAnnualEventSchedule(Engine engine)
    {
        var coverage = (OrdinalCoverage)CoverageFactory.Instance.Create(CoverageType.Ordinal);
    ...
    private static void CreateHolidaySchedule(Engine engine)
    {

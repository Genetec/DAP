...
async Task RunSample()
{
    ...
    {
        DisplayMapProperties(map);
    }

    void DisplayMapProperties(Map map)
    {
        ...
        DisplayMapObjects(map);

        Console.WriteLine();
    }

    void DisplayGeoView(GeoView view)
    {
        if (view == null)
        {
    ...
    void DisplayGeoBounds(GeoBounds bounds)
    {
        if (bounds == null)
        {
    ...
    void DisplayGeoReference(GeoReference geoReference)
    {
    ...
    void DisplayMapObjects(Map map)
    {
    ...
    void DisplaySpecificMapObjectProperties(MapObject mapObject)
    {
        switch (mapObject)
        {
    ...
    string FormatCoordinate(GeoCoordinate coordinate)
    {
...
async Task LoadMaps(Engine engine)
{
